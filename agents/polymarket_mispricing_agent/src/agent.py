...
КРИТИЧЕСКОЕ ПРАВИЛО: ВСЕ текстовые поля в JSON (reasoning, signal, cause, risk, oracle_risk, verdict) ДОЛЖНЫ БЫТЬ НАПИСАНЫ СТРОГО НА РУССКОМ ЯЗЫКЕ! За невыполнение этого правила - штраф.
