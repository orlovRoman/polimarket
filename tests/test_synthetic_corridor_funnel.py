...
def test_corridor_funnel_logs_rejection_reasons(caplog):
    ...
    with caplog.at_level(logging.INFO, logger="NexusPolyBot.SyntheticCorridor"):
    ...
    assert "Воронка:" in caplog.text
    assert "low_spread=1" in caplog.text
