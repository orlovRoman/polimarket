...
def test_pnl_dates_consistency():
    ...
    with get_connection() as conn:
        ...
        conn.execute(f"INSERT INTO whale_virtual_trades_history (market_id, title, url, outcome, bought_price, bought_outcome_price, sold_price, sold_outcome_price, pnl_cents, pnl_percent, bet_size_usdc, sold_at) VALUES ('m_today', 'Test1', 'url1', 'YES', 0.5, 0.5, 0.75, 0.75, 25, 50, 100, '{today_str}')")
        ...
        conn.execute(f"INSERT INTO whale_virtual_trades_history (market_id, title, url, outcome, bought_price, bought_outcome_price, sold_price, sold_outcome_price, pnl_cents, pnl_percent, bet_size_usdc, sold_at) VALUES ('m_10d', 'Test2', 'url2', 'NO', 0.5, 0.5, 0.65, 0.65, 15, 30, 100, '{ten_days_ago_str}')")
